...
/*
|--------------------------------------------------------------------------
| DATOS DE LA MESA DEL USUARIO..
|--------------------------------------------------------------------------
*/

$mesa = mysqli_query($con,"
SELECT mesas.*
...
$mesa = mysqli_fetch_assoc($mesa);

/*
|--------------------------------------------------------------------------
| TOTAL GENERAL DASHBOARD
|--------------------------------------------------------------------------
*/
...
<h2>Información Electoral</h2>

<p>
<b>Mesa asignada:</b>
<?php echo $mesa['numero_mesa']; ?>
</p>

<p>
<b>Departamento:</b>
<?php echo $mesa['departamento']; ?>
</p>

<p>
<b>Municipio:</b>
<?php echo $mesa['municipio']; ?>
</p>

<p>
<b>Centro:</b>
<?php echo $mesa['direccion']; ?>
</p>
...
$tipo_nombre = $categoria['nombre'];

$totalCategoria = $totalesCategoria[$tipo_id] ?? 0;

echo "
<div class='card'>
<h2 class='titulo'>$tipo_nombre</h2>
...
$candidatosCategoria = mysqli_query($con,"
SELECT
    candidatos.*,
    partidos.nombre AS partido
...
WHERE candidatos.tipo_id = '$tipo_id'

ORDER BY candidatos.votos DESC
");

while($c=mysqli_fetch_assoc($candidatosCategoria)){
